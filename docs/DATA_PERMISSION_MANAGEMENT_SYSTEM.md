...
| 数据权限管理                                                                 |
+------------------------------------------------------------------------------+
| 搜索框：_______________ 筛选：[数据类型] [权限类型] [状态]                    |
+------------------------------------------------------------------------------+
| 操作：[创建数据权限] [批量启用] [批量禁用] [批量删除]                       |
+------------------------------------------------------------------------------+
| 复选框 | 权限名称             | 权限标识        | 数据类型 | 权限类型    | 状态 | 操作      |
+--------+----------------------+-----------------+----------+-------------+------+-----------+
| [x]    | 用户管理-全部数据     | user_all        | user     | 全部数据    | 启用 | 编辑 删除  |
| [x]    | 用户管理-本人数据     | user_self       | user     | 本人数据    | 启用 | 编辑 删除  |
| [ ]    | 用户管理-本部门数据   | user_dept       | user     | 本部门数据  | 启用 | 编辑 删除  |
| [ ]    | 订单管理-全部数据     | order_all       | order    | 全部数据    | 启用 | 编辑 删除  |
| [ ]    | 订单管理-自定义金额权限| order_custom_amount | order  | 自定义数据  | 启用 | 编辑 删除  |
+--------+----------------------+-----------------+----------+-------------+------+-----------+
| 分页：上一页 1 2 3 下一页 共20条 每页10条                                   |
+------------------------------------------------------------------------------+
```
...
+------------------------------------------------------------------------------+
| 基本信息：                                                                    |
| 权限名称：__________________ *                                               |
| 权限标识：__________________ *                                               |
| 数据类型：[下拉选择] *                                                         |
| 权限类型：[单选：全部数据 | 本人数据 | 本部门数据 | 本部门及以下数据 | 自定义数据] * |
|                                                                              |
| [如果选择自定义数据，则显示：]                                               |
| 自定义过滤条件：                                                              |
| +--------------------------------------------------------------------------+ |
...
|                                                                              |
| 描述信息：                                                                    |
| __________________________ (多行文本框)                                       |
|                                                                              |
| 状态：[启用] [禁用] *                                                          |
+------------------------------------------------------------------------------+
| [保存] [取消]                                                               |
...
| 用户管理 - 共250条记录                                                       |
+------------------------------------------------------------------------------+
| 搜索框：_______________ 筛选：[状态] [部门]                                  |
+------------------------------------------------------------------------------+
| 复选框 | 用户名      | 部门          | 职位       | 状态   | 创建者     | 操作      |
+--------+-------------+---------------+------------+--------+------------+-----------+
| [ ]    | admin       | 系统管理部     | 管理员     | 启用   | system     | 编辑 删除  |
| [ ]    | ZhangSan    | 技术部         | 部门经理   | 启用   | admin      | 编辑 删除  |
| [ ]    | LiSi        | 市场部         | 销售人员   | 启用   | WangWu     | 编辑 删除  |
| [ ]    | WangWu      | 财务部         | 财务主管   | 启用   | admin      | 编辑 删除  |
| [ ]    | ZhaoLiu     | 技术部-前端组   | 开发工程师 | 启用   | ZhangSan   | 编辑 删除  |
+--------+-------------+---------------+------------+--------+------------+-----------+
| 分页：上一页 1 2 3 ... 25 下一页 共250条 每页10条                             |
+------------------------------------------------------------------------------+
```
...
| [ ]    | ZhangSan    | 技术部         | 部门经理   | 启用   | admin      | 编辑 删除  |
| [ ]    | ZhaoLiu     | 技术部-前端组   | 开发工程师 | 启用   | ZhangSan   | 编辑 删除  |
| [ ]    | SunQi       | 技术部-后端组   | 开发工程师 | 启用   | ZhangSan   | 编辑 删除  |
| [ ]    | ZhouBa      | 技术部-测试组   | 测试工程师 | 启用   | ZhangSan   | 编辑 删除  |
| [ ]    | WuJiu       | 技术部-前端组   | 前端开发   | 启用   | ZhaoLiu    | 编辑 删除  |
+--------+-------------+---------------+------------+--------+------------+-----------+
| 分页：上一页 1 2 3 4 5 下一页 共45条 每页10条                                 |
+------------------------------------------------------------------------------+
```
...
+--------+-------------+---------------+------------+--------+------------+-----------+
| [ ]    | WuJiu       | 技术部-前端组   | 前端开发   | 启用   | ZhaoLiu    | 编辑 删除  |
| [ ]    | ChenShi     | 技术部-前端组   | 实习生     | 启用   | ZhaoLiu    | 编辑 删除  |
| [ ]    | LinShiyi    | 技术部-前端组   | UI设计师   | 启用   | ZhaoLiu    | 编辑 删除  |
+--------+-------------+---------------+------------+--------+------------+-----------+
| 分页：共3条 每页10条                                                          |
+------------------------------------------------------------------------------+
```
