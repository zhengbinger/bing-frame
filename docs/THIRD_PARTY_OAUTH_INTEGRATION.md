...
![第三方登录系统全景图](images/oauth2_system_overview.svg)

> **图例说明**：蓝色表示核心服务，绿色表示前端应用，红色表示第三方平台，橙色表示数据存储
...
![第三方登录完整流程图](images/oauth2_flow_diagram.svg)

### 4.2 账号绑定管理思维导图

![账号绑定管理思维导图](images/oauth2_account_binding_mindmap.svg)
